...
const char *weatherHost = "api.darksky.net";

void getWeatherData()
{
  Serial.print("connecting to "); Serial.println(weatherHost);
  if (client.connect(weatherHost, 443)) {
    Serial.println(String("GET /forecast/") + weatherKey + "/" + cityID +"?units=si\r\n" +
                   "Host: " + weatherHost + "\r\nUser-Agent: ArduinoWiFi/1.1\r\n" +
                   "Connection: close\r\n\r\n");
                   
    client.println(String("GET /forecast/") + weatherKey + "/" + cityID +"?units=si HTTP/1.1\r\n" +
                   "Host: " + weatherHost + "\r\nUser-Agent: ArduinoWiFi\r\n" +
                   "Connection: close\r\n\r\n");
  } else {
...
//  Serial.println(wr);
  ...
  weatherString += "  Rain: " + String(clouds) + "%  "; // Regenrisiko
